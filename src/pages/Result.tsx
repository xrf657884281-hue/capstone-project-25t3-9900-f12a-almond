    ...
    <div className="min-h-screen px-6 py-10 bg-background text-foreground">
      <div className="mx-auto w-full max-w-7xl grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-5 space-y-4">
            ...
            <CardContent className="p-4 space-y-3">
              <div className="flex items-center justify-between">
                ...
                <span className="text-sm">
                  {typeof analysis.aiConfidence === "number" ? `${clamp01(analysis.aiConfidence)}%` : "--"}
                </span>
              </div>
              <Progress value={analysis.aiConfidence} />

              <div className="flex items-center justify-between pt-2">
                <span className="text-sm font-medium">Human Confidence</span>
                <span className="text-sm">
                  {typeof analysis.humanConfidence === "number" ? `${clamp01(analysis.humanConfidence)}%` : "--"}
                </span>
              </div>
              ...
              <div className="flex items-center justify-between pt-2">
                ...
                <span className="text-sm">
                  {typeof analysis.readability === "number" ? `${clamp01(analysis.readability)}%` : "--"}
                </span>
              </div>
          ...
          <Card className="border border-border">
            <CardContent className="p-4 space-y-3">
              <h3 className="font-semibold text-sm">Your most AI sentences</h3>
